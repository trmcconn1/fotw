...
strcpy(DialogData.shortmsg,"Enter last two digits of the new academic year.\nFor example enter 97 for Fall 96 and for Spring 97.\n");
...
name. You do not need to surround multiple words with quotes. \n\
When you are finished entering holidays, enter q to quit the holidays\n\
dialog.\n\n\n"
