...
/* In a future release of Bison, this section will be replaced
   by #include "cgi.tab.h".  */
#ifndef YY_YY_CGI_TAB_H_INCLUDED
# define YY_YY_CGI_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
union YYSTYPE
{
#line 55 "cgi.y" /* yacc.c:355  */

	char *str;
	

#line 173 "cgi.tab.c" /* yacc.c:355  */
};
...
#endif /* !YY_YY_CGI_TAB_H_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 190 "cgi.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "__AMPERSAND", "__EQUALS", "__TEXT",
  "__HEX", "__ENDFILE", "$accept", "finish", "parameter_list",
  "named_pair", "repaired_string", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 69 "cgi.y" /* yacc.c:1646  */
    {YYACCEPT; /* YYACCEPT prevents a
...
#line 1268 "cgi.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 76 "cgi.y" /* yacc.c:1646  */
    {;}
#line 1274 "cgi.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 79 "cgi.y" /* yacc.c:1646  */
    {
		strcpy(Pairs[NumberPairs].Name,
			(yyvsp[-3].str)); strcpy(Pairs[NumberPairs++].Value,(yyvsp[-1].str));}
#line 1282 "cgi.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 82 "cgi.y" /* yacc.c:1646  */
    {
		strcpy(Pairs[NumberPairs].Name,
			(yyvsp[-3].str)); strcpy(Pairs[NumberPairs++].Value,(yyvsp[-1].str));
			YYACCEPT;	}
#line 1291 "cgi.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 86 "cgi.y" /* yacc.c:1646  */
    {
		strcpy(Pairs[NumberPairs].Name,
			(yyvsp[-3].str)); strcpy(Pairs[NumberPairs++].Value,(yyvsp[-1].str));
			}
#line 1300 "cgi.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 90 "cgi.y" /* yacc.c:1646  */
    {
		strcpy(Pairs[NumberPairs].Name,
			(yyvsp[-3].str)); strcpy(Pairs[NumberPairs++].Value,(yyvsp[-1].str));
			YYACCEPT;}
#line 1309 "cgi.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 95 "cgi.y" /* yacc.c:1646  */
    { 
...
this for Values only, not names */
				...
				sprintf(buffer1,"%s",(yyvsp[-1].str));
				sprintf(buffer2,"%c",HexToA((yyvsp[0].str)));
				strcat(buffer1,buffer2);
				(yyval.str) = strcp(buffer1);}
#line 1325 "cgi.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 106 "cgi.y" /* yacc.c:1646  */
    { strcpy(buffer1,(yyvsp[-1].str));
				strcat(buffer1,(yyvsp[0].str));
				(yyval.str) = strcp(buffer1); }
#line 1333 "cgi.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 109 "cgi.y" /* yacc.c:1646  */
    {
				sprintf(buffer1,"%s",(yyvsp[-1].str));
				sprintf(buffer2,"%c",HexToA((yyvsp[0].str)));
				strcat(buffer1,buffer2);
				(yyval.str) = strcp(buffer1);}
#line 1343 "cgi.tab.c" /* yacc.c:1646  */
    break;


#line 1347 "cgi.tab.c" /* yacc.c:1646  */
      default: break;
    }
