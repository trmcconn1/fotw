...
// Parses the file named as TeamsFile in score.rc 
...
// Parse the file score.rc in the current directory 
		  ...
		  if(i<NOEVENTS){
                ...
                // Look up the index number of this event
                  ...
                  continue;
                        ...
                        fprintf(errstream, "Unable to interpret line from score.rc: %s\n",LineBuffer);
                        return 1;
                       
                    }     // end if: skip comments 
                }           // end while for parsing score.rc
                return 0;
} // end routine
