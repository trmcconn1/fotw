/* mkstnds.c: Read scortabl.asc and make a table of standards
	...
	table.c must be included in my score project.
*/
...
3. Add the name of the new age group at the appropriate place in
   the char *AgeGroups[] array in groups.h
...
#define NOEVENTS 16  /* Relays not included 11/10/06: added halfmarathon */
#define NOAGEGROUPS 34   /* Currently m11 - m89, f09-f74 */
